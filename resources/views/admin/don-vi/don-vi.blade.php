                ...
                <?php                     
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                              <button type="button" class="btn btn-gradient waves-effect waves-light suaDonVi" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="dripicons-document-edit"></i></button>
                            </td>
                            <td class="text-center">
