...
<table id="datatable-buttons" class="table table-hover table-bordered datatable-buttons" cellspacing="0" width="100%">'
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="">{{$nghiBu['name']}}</td>
            <td class="name"><?php echo $nghiBu['noi_dung_nghi_bu']; ?></td>
            ...
            <td class="name">{{$nghiBu['ten_nguoi_duyet']}}</td>
            <td class="name">{{$nghiBu['thoi_gian_duoc_duyet_nghi_bu']}}</td>
