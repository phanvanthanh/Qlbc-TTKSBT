            ...
            <div class="row">
                <div class="col-sm-12 col-md-9">
                    <div class="form-group{{ $errors->has('id') ? ' has-error' : '' }}">
                        ...
                        <div class="">                                
                            <select class="form-control" name="role_id" id="role_id" value="{{ old('id') }}" required autofocus width="100%">
        ...
        <div class="card-box table-responsive">
            <table id="_datatable-buttons" class="table table-hover table-bordered" cellspacing="0" width="100%">
                ...
                @foreach($resource as $key => $res)
                    <tr>
                        <td  class="text-center"><input type="checkbox" class="resource" name="resource_id[]" id="resource_id_{{ $res->id }}" value="{{ $res->id }}"></td>
                        <td  class="text-center">{{$key}}</td>
                        <td class="name">{{ $res->ten_hien_thi }}</td>
