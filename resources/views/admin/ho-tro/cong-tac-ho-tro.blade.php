            ...
            <form role="form" name="formCongTacHoTro" id="formCongTacHoTro">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-control" name="id_loai_danh_muc" id="id_loai_danh_muc">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="btnXem" style="color: white;">Xem báo cáo<span class="text-danger"></span></label>
                            <button type="button" class="btn btn-success waves-effect waves-light btnXem"><i class="mdi mdi-library-plus"></i>Xem báo cáo</button> 
                            <label for="baoCaoCongTacHoTroTuanWord" style="color: white;">Xuất báo cáo<span class="text-danger"></span></label>
                    ...
                    success:function(data){
                        ...
                        jQuery.each( data, function( key, value){
                            table+='<tr style="cursor:pointer;" >'
                                ...
                                +'<td><select class="form-control idDonViYeuCau">'
