            ...
            <table id="datatable-buttons" class="table table-hover table-bordered" cellspacing="0" width="100%">
                ...
                @foreach($users as $user)
                    <tr>
                        ...
                        <td class="text-center">
                          {!! Form::open(array('route'=>array('xoaNhanVien',$user['id']),'method'=>'DELETE','class'=>'frmDelete')) !!}
                            <button type="button" class="btn btn-danger btnDelete"><i class="dripicons-document-delete"></i></button>
                          {!! Form::close() !!}
                        </td>
