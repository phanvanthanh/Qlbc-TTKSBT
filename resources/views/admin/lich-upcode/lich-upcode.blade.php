            ...
            <form id="lichUpcode" name="lichUpcode">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-1">
                        ...
                        <input style="width: auto;border: 1px solid #dadada; border-radius: 4px;height: 38px;font-size: 15px;" type="time" name="thoi_gian_bat_dau_du_kien_gio" id="thoi_gian_bat_dau_du_kien_gio">
                        <label for="thoi_gian_ket_thuc_du_kien_gio" style="color: white;"> Giờ<span class="text-danger"></span></label>
                        <input style="width: auto;border: 1px solid #dadada; border-radius: 4px;height: 38px;font-size: 15px;" type="time" name="thoi_gian_ket_thuc_du_kien_gio" id="thoi_gian_ket_thuc_du_kien_gio">
                    </div>
                    ...
                    <div class="col-xs-12 col-md-1 tgtt_gio d-none">
                        ...
                        <input style="width: auto;border: 1px solid #dadada; border-radius: 4px;height: 38px;font-size: 15px;" type="time" name="thoi_gian_bat_dau_gio" id="thoi_gian_bat_dau_gio">
                        <label for="thoi_gian_ket_thuc_gio" style="color: white;"> Giờ<span class="text-danger"></span></label>
                        <input style="width: auto;border: 1px solid #dadada; border-radius: 4px;height: 38px;font-size: 15px;" type="time" name="thoi_gian_ket_thuc_gio" id="thoi_gian_ket_thuc_gio">
                    </div>
                    <div class="col-xs-12 col-md-1">
                ...
                xhr1 = $.ajax({
                    ...
                    success:function(data){
                        if(data.error==0){
                            ...
                            $.toast({
                                heading: 'Lỗi!',
                                text: 'Bạn không thể chỉnh sửa LỊCH này, xin vui lòng kiểm tra lại.',
                                position: 'top-right',
                                loaderBg: '#bf441d',
                                icon: 'error',
                                hideAfter: 3000,
