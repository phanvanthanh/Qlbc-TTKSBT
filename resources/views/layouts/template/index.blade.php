...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Phần Mềm Quản Lý Báo Cáo</title>
        ...
        <style type="text/css">
            ...
            table.table#datatable-buttons > tbody > tr > td, 
table.table#datatable-buttons > tbody > tr > th, 
table.table#datatable-buttons > tfoot > tr > td, 
table.table#datatable-buttons > tfoot > tr > th, 
table.table#datatable-buttons > thead > tr > td, 
table.table#datatable-buttons > thead > tr > th {
    padding-top: 3px;
    padding-left: 3px;
    padding-right: 3px;
    padding-bottom: 3px;
    ...
    <?php
        ...
        if($userId){
            ...
            $adminResources=\DB::select('
                select
                    adre.id, adre.parent_id, adre.ten_hien_thi, adre.uri
                from users as u
                            ...
                            <?php } 
                                ...
                                foreach ($adminResources as $key => $item) {
                                    if($item->parent_id==1){
                                        echo '
                                            <li>
                                                <a class="go-to" href="/'.$item->uri.'"><i class="fi-briefcase"></i> <span> '.$item->ten_hien_thi.' </span> <span class="menu-arrow"></span></a>';
        ...
        <script type="text/javascript">
            jQuery(document).ready(function() {
                ...
                jQuery('.go-to').on('click',function(){
                    ...
                    if(href!='http://qlbc-ttksbt.abc/#' && href!='https://qlbc-ttksbt.abc/#'){
